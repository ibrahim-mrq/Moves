...
public class TrendingAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TrendingAdapter(ArrayList<Trending> list, Context mContext, int a) {
        this.list = list;
        this.a = a;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ProductViewHolder) {
            ...
            final Trending lists = list.get(position);
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("date", lists.getFirstAirDate());
                    intent.putExtra("langueg", lists.getOriginalLanguage());
                    intent.putExtra("overview", lists.getOverview());
                    intent.putExtra("OriginalTitle", lists.getOriginalName());
    ...
    public void addItems(List<Trending> postItems) {
    ...
    class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        private void bind(Trending lists) {
            title.setText(lists.getOriginalName());
            language.setText(lists.getOriginalLanguage());
            ratingBar.setRating(lists.getVoteAverage());
