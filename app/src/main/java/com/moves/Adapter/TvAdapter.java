...
public class TvAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TvAdapter(ArrayList<Tv> list, Context mContext, int a) {
        this.list = list;
        this.a = a;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ProductViewHolder) {
            ...
            final Tv lists = list.get(position);
    ...
    public void addItems(List<Tv> postItems) {
    ...
    class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        private void bind(Tv lists) {
            title.setText(lists.getName());
